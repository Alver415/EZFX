...
rem INSTALLER_VERSION: the application version, e.g. 1.0.0, shown in "about" dialog
...
"%JAVA_HOME%\bin\jdeps" ^
  ...
  --print-module-deps target\classes\com\ezfx\AppLauncher.class > target\module-deps

set /p detected_modules=<target\module-deps
...
call "%JAVA_HOME%\bin\jpackage" ^
  ...
  --module-path "C:\projects\tools\javaFx\openjfx-23.0.2_windows-x64_bin-jmods\javafx-jmods-23.0.2" ^
  --name %INSTALLER_NAME% ^
  --main-class com.ezfx.AppLauncher ^
  --main-jar %MAIN_JAR% ^
