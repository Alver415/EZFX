...
public class MappedBinding<A, B> implements InvalidationListener, WeakListener {
    ...
    private MappedBinding(Property<A> propertyA, Property<B> propertyB, Converter<A, B> converter) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MappedBinding<?, ?> otherBinding) {
    ...
    private static List<MappedBinding<?, ?>> list = new ArrayList<>();
    public static <A, B> void bindBidirectional(Property<A> propA, Property<B> propB, Converter<A, B> converter) {
        checkParameters(propA, propB);
        final MappedBinding<A, B> binding = new MappedBinding<>(propA, propB, converter);
    ...
    public static <A, B> void unbind(Property<A> propertyA, Property<B> propertyB) {
        ...
        final MappedBinding<A, B> binding = new MappedBinding<>(propertyA, propertyB, null);
